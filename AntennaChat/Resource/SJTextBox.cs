...
namespace AntennaChat.Resource
{
    ...
    public class SJTextBox : TextBox
    {
        ...
        public static DependencyProperty WaterRemarkProperty = DependencyProperty.Register("WaterRemark", typeof(string), typeof(SJTextBox));
        /// <summary>
        /// 水印文字 
        /// </summary>
        ...
        public static DependencyProperty IsPasswordBoxProperty =
          DependencyProperty.Register("IsPasswordBox", typeof(bool), typeof(SJTextBox), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(OnIsPasswordBoxChange)));
        /// <summary>
        /// 是否为密码框
        /// </summary>
        ...
        public static DependencyProperty PasswordStrProperty =
          DependencyProperty.Register("PasswordStr", typeof(string), typeof(SJTextBox), new FrameworkPropertyMetadata(string.Empty, new PropertyChangedCallback(OnPasswordStrChange)));
        ...
        private static void OnPasswordStrChange(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            (sender as SJTextBox).SetStr();
        }
        ...
        private void SetStr()
        {
            if (IsPasswordBox)
            {
                ...
                this.Text = PasswordStr == "" ? "" : ConvertToPasswordChar(PasswordStr.Length);
